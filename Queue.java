...
public class Queue<T>{
    ...
    // Similar to enqueue() but allows the item to move towards the front
    // of the queue based on thei vip_level.
    // Specifically, get in front of other items with lower VIP level.
